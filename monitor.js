...
let provider = ethers.getDefaultProvider("wss://mainnet.infura.io/ws/v3/ --- API KEY HERE ---")

let topic = ethers.utils.id("nameRegistered(bytes32,address,uint256)");

// console.log(uniPoolABI);
let liqPool = new ethers.Contract(ETHUSDCPool, uniPoolABI, provider);
